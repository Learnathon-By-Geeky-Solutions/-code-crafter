...
public class CreateDoctorProfileRequest {
    ...
    public Doctor toEntity(User user) {
        return new Doctor(doctorTitle, doctorType, specialistCategory, dateOfBirth, nid, passport, registrationNo, experience, hospital, about, areaOfExpertise, patientCarePolicy, education, experienceInfo, awards, publications, user);
    }
}
