...
import com.xenon.data.repository.BloodResponseRepository;
...
public class BloodResponseServiceImpl extends BaseService implements BloodResponseService {

    private final BloodResponseRepository bloodResponseRepository;
    private final BloodRequestPostRepository bloodRequestPostRepository;

    @Override
    public ResponseEntity<?> createBloodResponseRequest(CreateBloodResponseRequest body) {
        ...
        try {
            bloodResponseRepository.save(body.toEntity(getCurrentUser(), post));
    ...
    private void validateCreateBloodResponseRequest(CreateBloodResponseRequest body) {
